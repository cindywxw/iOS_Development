...
//        }
    ...
    func configureView() {
        ...
        // load the webview as lastView or "https://duckduckgo.com/Apple"
        if url == nil {
...
//        guard let result = webView!(webView, shouldStartLoadWith: url, navigationType: <#T##UIWebViewNavigationType#>) else { showAlert() }
...
//        let mySharedNtwk = SharedNetworking()
        SharedNetworking.sharedInstance.startLoading()
...
//        let mySharedNtwk = SharedNetworking()
        SharedNetworking.sharedInstance.endLoading()
...
//    attribute: https://developer.apple.com/reference/uikit/uiwebviewdelegate
